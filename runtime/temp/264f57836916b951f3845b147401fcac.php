<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:85:"F:\phpStudy\PHPTutorial\WWW\item\public/../application/admin\view\category\index.html";i:1531712824;s:74:"F:\phpStudy\PHPTutorial\WWW\item\application\admin\view\public\header.html";i:1531310130;s:74:"F:\phpStudy\PHPTutorial\WWW\item\application\admin\view\public\footer.html";i:1530541141;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
...
<div class="page-container">
	...
	<img style="margin:20px" width="480" height="340" src="<?php echo url('index/map'); ?>"/>
	<div class="mt-20">
			...
			<tbody>
				...
				<tr class="text-c">
					...
					<td class="td-manage"><a href="<?php echo url('category/index',['parent_id'=>$vo['id']]); ?>">获取子栏目</a>
						...
						<a style="text-decoration:none" class="ml-5" onClick="o2o_del('<?php echo $vo['id']; ?>','<?php echo url('category/status',['id'=>$vo['id'],'status'=>-1]); ?>')" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
				</tr>
...
<?php echo pagination($categories); ?>
<!--包含头部文件-->
