<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:81:"F:\phpStudy\PHPTutorial\WWW\item\public/../application/admin\view\bis\detail.html";i:1531721654;s:74:"F:\phpStudy\PHPTutorial\WWW\item\application\admin\view\public\header.html";i:1531310130;s:74:"F:\phpStudy\PHPTutorial\WWW\item\application\admin\view\public\footer.html";i:1530541141;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
	...
	基本信息：
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-3">
				<input type="text" class="input-text" value="<?php echo $bisData['name']; ?>" placeholder=""  name="name">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-3">
				<input type="text" class="input-text" value="<?php echo $bisData['bank_info']; ?>" placeholder=""  name="bank_info">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">开户行名称:</label>
			<div class="formControls col-xs-8 col-sm-3">
				<input type="text" class="input-text" value="<?php echo $bisData['bank_name']; ?>" placeholder=""  name="bank_name">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">开户行姓名:</label>
			<div class="formControls col-xs-8 col-sm-3">
				<input type="text" class="input-text" value="<?php echo $bisData['bank_user']; ?>" placeholder=""  name="bank_user">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">法人:</label>
			<div class="formControls col-xs-8 col-sm-3">
				<input type="text" class="input-text" value="<?php echo $bisData['faren']; ?>" placeholder=""  name="faren">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">法人电话:</label>
			<div class="formControls col-xs-8 col-sm-3">
				<input type="text" class="input-text" value="<?php echo $bisData['faren_tel']; ?>" placeholder=""  name="faren_tel">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>邮箱：</label>
			<div class="formControls col-xs-8 col-sm-3">
				<input type="text" class="input-text" value="<?php echo $bisData['email']; ?>" placeholder=""  name="email">
			</div>
		</div>
		总店信息：
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-3">
				<input type="text" class="input-text" value="<?php echo $locationData['tel']; ?>" placeholder=""  name="tel">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">联系人:</label>
			<div class="formControls col-xs-8 col-sm-3">
				<input type="text" class="input-text" value="<?php echo $locationData['contact']; ?>" placeholder=""  name="contact">
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-3"> <span class="select-box">
				<select name="category_id" class="select categoryId">
					<option value="0">--请选择--</option>
					<?php if(is_array($categories) || $categories instanceof \think\Collection || $categories instanceof \think\Paginator): $i = 0; $__LIST__ = $categories;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>c
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-3">
				<input type="text" class="input-text" value="<?php echo $locationData['address']; ?>" placeholder=""  name="address">
			</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-3">
				<input type="text" class="input-text" value="<?php echo $locationData['open_time']; ?>" placeholder=""  name="open_time">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-3">
				<input type="text" class="input-text" value="<?php echo $accountData['username']; ?>" placeholder=""  name="username">
			</div>
		</div>
	</form>
</article>
